    ...
    >
      <div>
        ...
        >
          ...
          >
            <Image
              src={"/vishnu-gurav.jpg"}
              alt="Person Image"
              width={400}
              height={400}
              priority={true}
              className="h-auto w-[250px] rounded-full border-2 border-gray-600 dark:border-white transition-colors"
            />
            <motion.span
          ...
          <div className="flex items-center justify-center gap-x-2 flex-wrap">
            <p className="text-lg tracking-wider text-gray-700 dark:text-gray-200 transition-colors">
              Exploring AI & Data Science 🚀 <span className="web:hidden xs:hidden">||</span>
            </p>
            <p className="text-lg tracking-wider text-gray-700 dark:text-gray-200 transition-colors">
              DSA Enthusiast 🧠 <span className="web:hidden xs:hidden">||</span>
            </p>
             <p className="text-lg tracking-wider text-gray-700 dark:text-gray-200 transition-colors">
